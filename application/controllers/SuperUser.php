...
public function index($qan_id=0){
    ...
    if($qan_id > 0){
        ...
        if( (@$this->session->userdata['permission']['PRODSU2']['de'] OR @$this->session->userdata['permission']['PRODSU2']['ack'] OR @$this->session->userdata['permission']['PRODSU2']['app']) ) //6
        {
            ...
            // if(@$view['data']->confirmation >= 11 OR (@$this->session->userdata['permission']['PSU2.1']['de'] and @$view['data']->confirmation == 1) OR (@$this->session->userdata['permission']['PSU2.1']['de'] and @$view['data']->confirmation == 10) ){
        ...
        if(@$this->session->userdata['permission']['ENGSU3']['de'] OR @$this->session->userdata['permission']['ENGSU3']['ack'] OR @$this->session->userdata['permission']['ENGSU3']['app'])
        {
            ...
            //     if(@$this->session->userdata['permission']['S3.2']['de'] AND @$view['data']->inspection_machine_data AND count(@$last_inspection_data->inspection_data) == 0)
            //     {
            //         $btn = 'UPDATE';
            //     }
            ...
            // {
            //     if(is_array(@$all_inspection_data->inspection_data) AND count(@$all_inspection_data->inspection_data) == 0)
            //     $button_obj = new stdClass();
            //     $button_obj->name = 'UPDATE';
            ...
            // if((@$this->session->userdata['permission']['QASU3']['de'] or @$this->session->userdata['permission']['QASU3']['ack'])){
            //     $button_obj = new stdClass();
            ...
            // if((@$this->session->userdata['permission']['QASU3.2']['de']) AND @$view['data']->inspection_machine_data AND count(@$view['data']->inspection_machine_data) > 0){
            //     $button_obj = new stdClass();
            //     $button_obj->name = 'UPDATE';
            //     $button_obj->value = 'update_section3';
            //     $button_obj->action = base_url().'SuperUser/index/';
