                        ...
                        <div class="body">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                            <input type="text" id="datetime" name="datetime" class="<?php echo @$section['S1']['see']?'datetimepicker':'';?>  form-control" <?php echo @$section['S1']['see']?'':'disabled';?> value='<?php echo $data[0]->datetime;?>' />
                                    ...
                                    <!-- <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="issued_dept" name="issued_dept" class="<?php echo @$section['S1']['see']?'show-tick':'';?>  form-control" <?php echo @$section['S1']['see']?'':'disabled';?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="shift" name="shift" class="<?php echo @$section['S1']['see']?'show-tick':'';?>  form-control" <?php echo @$section['S1']['see']?'':'disabled';?>>
                                                    <option value="">--Please Select--</option>
                                ...
                                <!-- <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="cav_no" name="cav_no" class="form-control" value='<?php echo $data[0]->cav_no;?>' <?php echo @$section['S1.1']['see']?'':'disabled';?>>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                            <input type="text" id="machine_no" name="machine_no" class="form-control" value='<?php echo $data[0]->machine_no;?>' <?php echo @$section['S1.1']['see']?'':'disabled';?>>
                                                <label class="form-label">M/C NO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="up_affected" name="up_affected" class="form-control" value='<?php echo $data[0]->up_affected;?>' <?php echo @$section['S1.1']['see']?'':'disabled';?>>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="last_passed_sample" name="last_passed_sample" class="<?php echo @$section['S1.1']['see']?'datetimepicker':'';?>  form-control" <?php echo @$section['S1.1']['see']?'':'disabled';?> value='<?php echo $data[0]->last_passed_sample;?>'>
                                ...
                                <div class="clearfix"></div>
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                <input type="text" id="qa_reinsp_verification_user_id" name="qa_reinsp_verification_user_id" class="form-control" value='<?php echo $user[$data[0]->qa_reinsp_verification_user_id];?>' <?php echo @$section['S2.2']['app']?'':'disabled';?>>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form method="post" action="<?php echo base_url().'FrontEnd/addnewsubmission/'.$data[0]->machine_id ;?>"> 
                            <div class="row clearfix">
                                <!-- [TABS] -->
                                <div class="body">
                                <!-- Nav tabs -->
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_pic_user" name="rcfa_pic_user[]" class="form-control" value="<?php echo $fullname; ?>" disabled/>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_ack_by_eng" name="rcfa_ack_by_eng[]" class="form-control" value="<?php echo $fullname; ?>" disabled/>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_approved_by" name="rcfa_approved_by[]" class="form-control" disabled>
                                    ...
                                    <b class="qasubmission">QA Inspection Data - 0st Submission</b>
                                        ...
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="submit_by" name="submit_by[]" class="form-control" value="<?php echo $fullname; ?>">
                                            ...
                                            <?php 
                                                echo '<tr>';
                                                    ...
                                                    foreach($inspection_machine as $inspectionmachine)
                                                    {
                                                        ...
                                                        echo '
                                                            <th align="center"><input type="checkbox" id="insp_machine'.$inspectionmachine->id.'_machine" name="qa_insp_machine['.$inspectionmachine->id.']" class="filled-in checkbox-tab" '.(@$section['S3.1']['de']?'':'disabled').'>
                                                                <label for="insp_machine'.$inspectionmachine->id.'_machine"></label>'.$inspectionmachine->name.'
                                                            </th>
                                                        ';
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_pic_user" name="rcfa_pic_user[<?php echo $subno;?>][]" class="form-control" value="<?php echo $user[$rcsubmissiondata->rcfa_pic_user_id];?>" <?php echo @$section['S3.1']['see']?'':'disabled';?>>
                                            <label class="form-label">PERSON IN-CHARGE</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_ack_by_eng" name="rcfa_ack_by_eng[<?php echo $subno;?>][]" class="form-control" value="<?php echo $user[$rcsubmissiondata->rcfa_ack_user_id];?>" <?php echo @$section['S3.2']['ack']?'':'disabled';?>>
                                            <label class="form-label">ACKNOWLEDGED BY <i>Engineer / Manager (Eng Dept)</i></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_approved_by" name="rcfa_approved_by[<?php echo $subno;?>][]" class="form-control" <?php echo @$section['S3.3']['app']?'':'disabled';?>>
                                            <label class="form-label">APPROVED BY <i>Leader & Above</i></label>
                                        </div>
                                    </div>
                                </div>
                                
                                <b>QA Inspection Data - Submission <?php echo $subno;?></b><br/>
                                    <!-- <div class="form-group form-float"><br/>
                                        <div class="form-line">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="completion_user_id" name="completion_user_id[<?php echo $subno;?>][]" class="form-control" value="<?php echo $user[$rcsubmissiondata->completion_user_id];?>" <?php echo @$section['S3.1']['see']?'':'disabled';?>>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="completion_datetime" name="completion_datetime[<?php echo $subno;?>][]" class="form-control" value="<?php echo $rcsubmissiondata->completion_datetime;?>" <?php echo @$section['S3.1']['see']?'':'disabled';?>>
                                        ...
                                        if($tablecol==0){
                                            ...
                                            echo $row[$tablerow][$tablecol];
                                                ...
                                                if($tablerow==1){
                                                    ...
                                                    // $insp_id_val = 'inspect_by'.$cb_id.'_';
                                                ...
                                                if($tablerow==2){
                                                    ...
                                                    //$time_start_val = 'time_start'.$cb_id.'_';
                                                ...
                                                if($tablerow==4){
                                                    ...
                                                    // $result_id_val = 'rc_result'.$cb_id.'_';
                    ...
                    <div class="card">
                        <div class="body">
                                <div class="row clearfix">
                                    ...
                                    <input type="hidden" name="machine_breakdown_id" value="<?php echo $machine_breakdown_id;?>" />
                                    <button id="form" type="submit" name="submit" value="SUBMIT" class="btn btn-success m-t-15 waves-effect pull-right">Save Changes</button>
                                </div>
                        </div>
                    </div>
                </div>
