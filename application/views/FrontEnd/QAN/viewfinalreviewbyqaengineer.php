...
<!-- Vertical Layout | With Floating Label -->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="<?php echo base_url().'FrontEnd/reviewbyqaform' ?>">
                                <div class="row clearfix">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="purging_completed1" name="purging_completed" class="with-gap" value="1">
                                        <label for="purging_completed1">YES</label>
                                        <input type="radio" id="purging_completed2" name="purging_completed" class="with-gap" value="0">
                                        <label for="purging_completed2">No</label>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="closed_by" name="closed_by" class="form-control" value="<?php echo $fullname;?>">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="notify_next1" name="notify_next" class="with-gap" value="1">
                                        <label for="notify_next1">YES</label>
                                        <input type="radio" id="notify_next2" name="notify_next" class="with-gap" value="0">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="validation_result1" name="validation_result" class="with-gap" value="1">
                                        <label for="validation_result1">PASS</label>
                                        <input type="radio" id="validation_result2" name="validation_result" class="with-gap" value="0">
