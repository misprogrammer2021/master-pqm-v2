...
<form method="post" action="<?php echo base_url().'FrontEnd/updatedmachinebreakdown/'.$data[0]->machine_id ;?>">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input type="hidden" name="issueto_user_id" value='<?php echo $data[0]->issueto_user;?>'/>
                                                ...
                                                <?php
                                                    ...
                                                    //{
                                                        //$selected = '';
                                                        //if ($data[0]->issueto_user == $issuetouser['id']){
                                                            //$selected = 'selected';
                                                        //}
                                                        //echo '<option value="'.$issuetouser['id'].'" '.$selected.'>'.$issuetouser['fullname'].'</option>';
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="datetime" name="datetime" class="<?php echo @$section['S1']['de']?'datetimepicker':'';?>  form-control" <?php echo @$section['S1']['de']?'':'disabled';?> value='<?php echo $data[0]->datetime;?>' required/>
                                                <label class="form-label">DATETIME</label>
                                            </div>
                                        </div>
                                        <input type="checkbox" id="ooc" name="ooc" class="filled-in" value="1" <?php if ($data[0]->ooc == '1') echo 'checked';?> <?php echo @$section['S1']['de']?'':'disabled';?>>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="issued_dept" name="issued_dept" class="<?php echo @$section['S1']['de']?'show-tick':'';?>  form-control" <?php echo @$section['S1']['de']?'':'disabled';?> required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="to_dept" name="to_dept" class="show-tick form-control" disabled>
                                                    <option value="">--Please Select--</option>
                                        ...
                                        <div class="clearfix"></div>
                                            <input type="checkbox" id="oos" name="oos" class="filled-in" value="1" <?php if ($data[0]->oos == '1') echo 'checked';?> <?php echo @$section['S1']['de']?'':'disabled';?> required>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="part_name" name="part_name" class="<?php echo @$section['S1.1']['de']?'show-tick':'';?>  form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                                <option value="">--Please Select--</option>
                                                <?php
                                        ...
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="cav_no" name="cav_no" class="form-control" value='<?php echo $data[0]->cav_no;?>' <?php echo @$section['S1.1']['de']?'':'disabled';?> required/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="machine_no" name="machine_no" class="form-control" value='<?php echo $data[0]->machine_no;?>' <?php echo @$section['S1.1']['de']?'':'disabled';?> required/>
                                                <label class="form-label">M/C NO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="up_affected" name="up_affected" class="form-control" value='<?php echo $data[0]->up_affected;?>' <?php echo @$section['S1.1']['de']?'':'disabled';?> required/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="process" name="process" class="<?php echo @$section['S1.1']['de']?'show-tick':'';?>  form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                                <option value="">--Please Select--</option>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="detectedby_user" name="detectedby_user" class="<?php echo @$section['S1.1']['de']?'show-tick':'';?>  form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                                <option value="">--Please Select--</option>
                                                <?php
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <textarea id="defect_description" name="defect_description" class="form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?>><?php echo $data[0]->defect_description;?></textarea>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="last_passed_sample" name="last_passed_sample" class="<?php echo @$section['S1.1']['de']?'datetimepicker':'';?>  form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> value='<?php echo $data[0]->last_passed_sample;?>' required/>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                        $selected = '';
                                                        if ($data[0]->ack_eng_user == $ackbyeng['id']){
                                                            $selected = 'selected';
                                                        }
                                                        echo '<option value="'.$ackbyeng['id'].'" '.$selected.'>'.$ackbyeng['fullname'].'</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="purge_from" name="purge_from" class="<?php echo @$section['S1.1']['de']?'datetimepicker':'';?>  form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> value='<?php echo $data[0]->purge_from;?>'/>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <?php
                                                    ...
                                                    //{
                                                        //$selected = '';
                                                        //if ($data[0]->ack_prod_user == $ackbyprod['id']){
                                                            //$selected = 'selected';
                                                        //}
                                                        //echo '<option value="'.$ackbyprod['id'].'" '.$selected.'>'.$ackbyprod['fullname'].'</option>';
                                                    //}
                                                    ?>
                                                </select>
                                            </div>
                                            ...
                                            <table class="table table-hover table-bordered">
                                                ...
                                                <?php 
                                                    ...
                                                    echo "<tr>";    
                                                        ...
                                                        echo "<td>";
                                                            echo "<input type='number' id='input_qty_prod' value='' name='input_qty_prod[$prodloc->id]' class='form-control'".(@$section['S1.3']['de']?'':'disabled').">";
                                                        echo "</td>";
                                                    echo "</tr>";
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="estimate_qty" name="estimate_qty" class="form-control" value='<?php echo $data[0]->estimate_qty;?>' <?php echo @$section['S1.1']['ack']?'':'disabled';?>/>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <?php
                                                    ...
                                                    //{
                                                        //$selected = '';
                                                        //if ($data[0]->ack_qa_user == $ackbyqa['id']){
                                                            //$selected = 'selected';
                                                        //}
                                                        //echo '<option value="'.$ackbyqa['id'].'" '.$selected.'>'.$ackbyqa['fullname'].'</option>';
                                                    //}
                                                    ?>
                                                </select>
                                            </div>
                                            ...
                                            <table class="table table-hover table-bordered qasample-form">
                                                ...
                                                <?php 
                                                    ...
                                                    echo "<tr>";    
                                                        ...
                                                        echo "<td>";
                                                            echo "<input type='number' value='$tempqty' name='input_qty_qasample[$qasampleloc->id]' class='form-control input_qty_qasample'".(@$section['S1.2']['de']?'':'disabled').">";
                                                        echo "</td>";
                                                    echo "</tr>";
                                    ...
                                    <button id="form" type="submit" name="update" value="SUBMIT" class="btn btn-success m-t-15 waves-effect pull-right" <?php echo @$section['S1']['de']?'':'disabled';?>>Save changes</button>
