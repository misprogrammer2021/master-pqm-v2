                        ...
                        <form method="post" action="<?php echo base_url().'FrontEnd/rootcausefailureform' ?>"> 
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea id="root_cause" name="root_cause[1][]" class="form-control"></textarea>
                                            <label class="form-label">ROOT CAUSE</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea id="corrective_action" name="corrective_action[1][]" class="form-control"></textarea>
                                            <label class="form-label">CORRECTIVE ACTION</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_pic_user" name="rcfa_pic_user[1][]" class="form-control" value="<?php echo $fullname; ?>">
                                            <label class="form-label">PERSON IN-CHARGE</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_ack_by_eng" name="rcfa_ack_by_eng[1][]" class="form-control" value="<?php echo $fullname; ?>">
                                            <label class="form-label">ACKNOWLEDGED BY <i>Engineer / Manager (Eng Dept)</i></label>
                                        </div>
                                    </div>
                                </div>
