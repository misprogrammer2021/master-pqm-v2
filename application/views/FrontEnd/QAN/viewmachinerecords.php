...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            ...
            <li><i class="material-icons">library_books</i>View Machine Breakdown Records</li>
            </ol>
        </div>
    </div>
</section>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="cav_no" name="cav_no" class="form-control" value='<?php echo $data[0]->cav_no;?>'/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" name="ack_eng_user" class="form-control" value='<?php echo $user[$data[0]->ack_eng_user];?>'/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" name="ack_prod_user" class="form-control" value='<?php echo $user[$data[0]->ack_prod_user];?>'/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" name="ack_qa_user" class="form-control" value='<?php echo $user[$data[0]->ack_qa_user];?>'/>
