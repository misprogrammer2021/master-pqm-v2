    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-teal">
                ...
                <!-- <li class="active"><a href="<?=base_url('FrontEnd/dashboardqamachinebreakdown')?>"><i class="material-icons">library_books</i> View All Machine Breakdown</a></li> -->
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <button class="btn bg-green btn-lg btn-block waves-effect pull-right" type="button">
                                       ...
                                       <input type="text" id="qan_no" name="qan_no" class="form-control" value="<?php echo $data[0]->qan_no;?>" disabled/>
                                    </button>
                                </li>
                                <li>
                                    <button class="btn bg-green btn-lg btn-block waves-effect pull-right" type="button">
                                        ...
                                        <input type='text' id='status' name='status' class='form-control' value='<?php echo $data[0]->status;?>' disabled/>
                                    </button>
                                </li>
                                <li class="dropdown">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="cav_no" name="cav_no" class="form-control" disabled/>
