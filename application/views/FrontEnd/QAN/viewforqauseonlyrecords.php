    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-teal">
                ...
                <li><i class="material-icons">library_books</i> For QA Use Only Form</li>
            </ol>
        </div>
    </div>
</section>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="cav_no" name="cav_no" class="form-control" value='<?php echo $data[0]->cav_no;?>' disabled/>
                                ...
                                <div class="clearfix"></div>
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="qa_reinsp_verification_user_id" name="qa_reinsp_verification_user_id" class="form-control" disabled>
...
<!-- Vertical Layout | With Floating Label -->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="<?php echo base_url().'FrontEnd/updateforqaonly/'.$data[0]->machine_id ;?>">
                                <div class="row clearfix">
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <input type="radio" id="machine_status1" name="machine_status" class="with-gap" value="1" <?php if ($data[0]->machine_status == '1') echo 'checked';?> /> 
                                            <label for="machine_status1">RUN</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="approval_user_id" name="approval_user_id" class="form-control" value='<?php echo $user[$machineinfo[0]->approval_user_id];?>' disabled/>
                                                    <label class="form-label">APPROVED BY</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="radio" id="machine_status2" name="machine_status" class="with-gap" value="0" <?php if ($data[0]->machine_status == '0') echo 'checked';?> /> 
                                            <label for="machine_status2">STOP</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="machine_stop_reason" name="machine_stop_reason" class="form-control" value='<?php echo $data[0]->machine_stop_reason;?>' />  
