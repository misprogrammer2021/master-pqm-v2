            ...
            <div class="body">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="userpermission">
                        <form method="post" class="form-horizontal" role="form" action="<?php echo base_url().'FrontEnd/ProcessingRolePermission';?>"> <!--'FrontEnd/AddRolePermission' old--> 
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="userrole">
                        <form method="post" class="form-horizontal" role="form" action="<?php echo base_url().'FrontEnd/ProcessingPermission' ?>"> <!--'FrontEnd/AddPermision' old -->
                            <div class="table-responsive">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="section">
                        <form method="post" class="form-horizontal" role="form" action="<?php echo base_url().'FrontEnd/ProcessingSection';?>"> <!-- 'FrontEnd/UpdateSection' ProcessingSection-old -->
                            <div class="table-responsive">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="form-horizontal" role="form" action="<?php echo base_url().'FrontEnd/ProcessingRole' ?>"> <!--FrontEnd/ViewUserRole' old-->
...
<div class="modal fade" id="addNewSection" tabindex="-1" role="dialog" aria-labelledby="addNewSection" aria-hidden="true">    
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="form-horizontal" role="form" action="<?php echo base_url().'FrontEnd/ProcessingSection' ?>"> <!-- 'FrontEnd/ViewSection' old-->
                    <div class="col-md-6 col-sm-6">
                        <div class="col-md-6"> 
