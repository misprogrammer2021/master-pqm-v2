    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-teal">
                ...
                <li><i class="material-icons">library_books</i> For QA Use Only</li>
            </ol>
        </div>
    </div>
</section>
                                            ...
                                            <table class="table table-hover table-bordered mrb-form">
                                                ...
                                                <?php 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input type="text" id="total-affqty" name="qa_sample_affected_qty" class="form-control qasample-qty" value='<?php echo $totalSample;?>'>
                                                        </td>
                                                        <td>
                        ...
                        <div class="body"> 
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea id="root_cause" name="root_cause[]" class="form-control" disabled><?php echo $data[0]->root_cause;?></textarea>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea id="corrective_action" name="corrective_action[]" class="form-control" disabled><?php echo $data[0]->corrective_action;?></textarea>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_pic_user" name="rcfa_pic_user[]" class="form-control" value='<?php echo $user[$data[0]->rcfa_pic_user_id];?>' disabled/>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_ack_by_eng" name="rcfa_ack_by_eng[]" class="form-control" value='<?php echo $user[$data[0]->rcfa_ack_user_id];?>' disabled/>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_approved_by" name="rcfa_approved_by[]" class="form-control" value="<?php echo $fullname;?>" disabled>
                                    ...
                                    <b class="qasubmission">QA Inspection Data - 0st Submission</b>
                                        ...
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="submit_by" name="submit_by[]" class="form-control" value='<?php echo $user[$data[0]->completion_user_id];?>' disabled/>
                                        ...
                                        <table class="table table-hover table-bordered rootcause-form">
                                            ...
                                            <?php 
                                                echo '<tr>';
                                                    ...
                                                    foreach($inspection_machine as $inspectionmachine)
                                                    {
                                                        ...
                                                        echo '
                                                            <th align="center"><input type="checkbox" id="insp_machine_'.$inspectionmachine->id.'_machine" name="qa_insp_machine['.$inspectionmachine->id.']" class="filled-in checkbox-tab" disabled>
                                                    ...
                                                    foreach($inspection_machine as $inspectionmachine)
                                                    {
                                                        echo '<td>';
                                                            echo '<div class="selectresult">';
                                                                ...
                                                                echo '
                                                                    <select id="inspect_by'.$inspectionmachine->id.'_" class="form-control show-tick" name="inspect_by['.$inspectionmachine->id.'][]"> disabled';
                                            ...
                                            <?php 
                                                echo '<tr>';
                                                    ...
                                                    {
                                                        echo '
                                                            <td><input id="time_start'.$inspectionmachine->id.'_" type="text" name="time_start['.$inspectionmachine->id.'][]" class="timepicker form-control" disabled></td>
                                            ...
                                            <?php 
                                                echo '<tr>';
                                                    ...
                                                    {
                                                        echo '
                                                            <td><input id="time_end'.$inspectionmachine->id.'_" type="text" name="time_end['.$inspectionmachine->id.'][]" class="timepicker form-control" disabled></td>
                                                    ...
                                                    foreach($inspection_machine as $inspectionmachine)
                                                    {
                                                        echo '<td>';
                                                            echo '<div class="selectresult">';
                                                                ...
                                                                echo '
                                                                        <select id="rc_result'.$inspectionmachine->id.'_" class="form-control show-tick" name="rc_result['.$inspectionmachine->id.'][]" disabled> 
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_approved_by" name="rcfa_approved_by[1][]" class="form-control" value="<?php echo $fullname;?>" disabled>
                                            <label class="form-label">APPROVED BY <i>Leader & Above</i></label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        if($tablecol==0){
                                            ...
                                            echo $row[$tablerow][$tablecol];
                                                ...
                                                if($tablerow==0){
                                                    ...
                                                    echo '<input type="checkbox" disabled id="'.$cb_id_val.'" name="qa_insp_machine['.$subno.']['.$cb_id.']" class="filled-in checkbox-tab" '.$cb_checked.'/>';
                                                ...
                                                if($tablerow==2){
                                                    ...
                                                    echo '<input id="'.$time_start_val.'" type="text" name="time_start['.$subno.']['.$cb_id.']" value="'.$row[$tablerow][$tablecol].'" disabled class="timepicker form-control">';
                                                }

                                                if($tablerow==3){

                                                    $time_end_val = 'time_end_'.$subno.'_machine'.$cb_id;
                                                    echo '<input id="'.$time_end_val.'" type="text" name="time_end['.$subno.']['.$cb_id.']" value="'.$row[$tablerow][$tablecol].'" disabled class="timepicker form-control">';
                                                }
