                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <button class="btn bg-green btn-lg btn-block waves-effect pull-right" type="button">
                                       ...
                                       <input type='text' id='qan_no' name='qan_no' class='form-control' value='<?php echo $productionpart[0]->qan_no;?>' readonly/>
                                    </button>
                                </li>
                                <li>
                                    <button class="btn bg-green btn-lg btn-block waves-effect pull-right" type="button">
                                        ...
                                        <input type='text' id='status' name='status' class='form-control' value='<?php echo $productionpart[0]->status;?>' readonly />
                                    </button>
                                </li>
                                <li class="dropdown">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="issued_by_user" name="issued_by_user" class="form-control" value='<?php echo $user[$productionpart[0]->issueby_user_id];?>'/>
                                                <label class="form-label">ISSUED BY</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="issueto_user" name="issueto_user" class="form-control" value='<?php echo $user[$productionpart[0]->issueto_user];?>'/>
                                                <label class="form-label">TO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="datetime" name="datetime" class="datetimepicker form-control" value='<?php echo $productionpart[0]->datetime;?>'/>
                                                <label class="form-label">DATETIME</label>
                                            </div>
                                        </div>
                                        <input type="checkbox" id="ooc" name="ooc" class="filled-in" value="1" <?php if ($productionpart[0]->ooc == '1') echo 'checked';?>>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="issued_dept" name="issued_dept" class="form-control" value='<?php echo $productionpart[0]->issued_dept;?>'/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="to_dept" name="to_dept" class="form-control" value='<?php echo $productionpart[0]->to_dept;?>'/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="shift" name="shift" class="form-control" value='<?php echo $productionpart[0]->shift;?>'/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                            <input type="checkbox" id="oos" name="oos" class="filled-in" value="1" <?php if ($productionpart[0]->oos == '1') echo 'checked';?>>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="part_name" name="part_name" class="form-control" value='<?php echo $partname[$productionpart[0]->part_name];?>'/>
                                                </div>
                                            </div>
                                        </div><br/>
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="cav_no" name="cav_no" class="form-control" value='<?php echo $productionpart[0]->cav_no;?>'/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="machine_no" name="machine_no" class="form-control" value='<?php echo $productionpart[0]->machine_no;?>'/>
                                                <label class="form-label">M/C NO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="up_affected" name="up_affected" class="form-control" value='<?php echo $productionpart[0]->up_affected;?>'/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="process" name="process" class="form-control" value='<?php echo $procees[$productionpart[0]->process];?>'/>
                                                </div>
                                            </div>
                                        </div><br/>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="detectedby_user" name="detectedby_user" class="form-control" value='<?php echo $user[$productionpart[0]->detectedby_user];?>'/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <textarea id="defect_description" name="defect_description" class="form-control"><?php echo $productionpart[0]->defect_description;?></textarea>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="last_passed_sample" name="last_passed_sample" class="datetimepicker form-control" value='<?php echo $productionpart[0]->last_passed_sample;?>'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_eng_user" name="ack_eng_user" class="form-control" value='<?php echo $user[$productionpart[0]->ack_eng_user];?>'/>
                                                </div>
                                            </div>
                                        </div><br/>
                                    </div>  
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="purge_from" name="purge_from" class="datetimepicker form-control" value='<?php echo $productionpart[0]->purge_from;?>'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_prod_user" name="ack_prod_user" class="form-control" value='<?php echo $user[$productionpart[0]->ack_prod_user];?>'/>
                                                </div>
                                            </div>
                                        </div><br/>  
                                        <form method="post" action="<?php echo base_url().'FrontEnd/updatedproduction/'.$productionpart[0]->machine_id ;?>">
                                        <div class="col-md-12 col-sm-12">
                                            <table class="table table-hover table-bordered">
                                                ...
                                                <?php 
                                                    ...
                                                    echo "<tr>";    
                                                        ...
                                                        echo "<td>";
                                                            echo "<input type='number' value='$tempqty' name='input_qty_prod[$prodloc->id]' class='form-control input_qty_prod'>";
                                                        echo "</td>";
                                                    echo "</tr>";
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="estimate_qty" name="estimate_qty" class="form-control" value='<?php echo $productionpart[0]->estimate_qty;?>'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_qa_user" name="ack_qa_user" class="form-control" value='<?php echo $user[$productionpart[0]->ack_qa_user];?>'/>
                                                </div>
                                            </div>
                                        </div><br/>  
                                        <div class="col-md-12 col-sm-12">
