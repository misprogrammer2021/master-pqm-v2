                                ...
                                <div class="clearfix"></div>
                                    <div class="col-md-12 col-sm-12">
                                            ...
                                            <table class="table table-hover table-bordered mrb-form">
                                                ...
                                                <?php 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <input type="checkbox" id="loc_purge'.$loctopurge->id.'" name="loc_purge['.$loctopurge->id.']" class="filled-in checkbox-active"'.(@$section['S2.1']['de']?'':'disabled').'>
                                                                <label for="loc_purge'.$loctopurge->id.'"></label>
                                                            </td>
                                                            <td>
                                                                <input type="number" name="aff_qty['.$loctopurge->id.']" class="form-control" '.(@$section['S2.1']['de']?'':'disabled').'>
                                                            </td>
                                                            <td>
                                                                <input type="number" name="good_qty['.$loctopurge->id.']" class="form-control good-total" '.(@$section['S2.1']['de']?'':'disabled').'>
                                                            </td>
                                                            <td>
                                                                <input type="number" name="rej_qty['.$loctopurge->id.']" class="form-control reject-total" '.(@$section['S2.1']['de']?'':'disabled').'>
                                                            </td>
                                                            <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input type="number" name="qa_sample_affected_qty" class="form-control qasample-qty" value='<?php echo $totalSample;?>' <?php echo @$section['S2.1']['de']?'':'disabled';?>/>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="qa_sample_good_qty" value="" class="form-control qasample-qty" <?php echo @$section['S2.1']['de']?'':'disabled';?>/>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="qa_sample_reject_qty" value="" class="form-control qasample-qty" <?php echo @$section['S2.1']['de']?'':'disabled';?>/>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="checkbox" id="scrap" name="scrap" class="filled-in" value="1" onclick="enableDisableAll();" <?php echo @$section['S2.1']['de']?'':'disabled';?>>
                                            <label for="scrap">SCRAP</label>
                                            <input type="checkbox" id="rework" name="rework" class="filled-in" value="1" onclick="enableDisableAll();" <?php echo @$section['S2.1']['de']?'':'disabled';?>>
                                            <label for="rework">REWORK</label>
                                            <input type="checkbox" id="UAI" name="UAI" class="filled-in" value="1" onclick="enableDisableAll();" <?php echo @$section['S2.1']['de']?'':'disabled';?>>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="UAI_no" name="UAI_no" class="form-control" disabled/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="reported_by_mrb" name="reported_by_mrb" class="form-control" value="<?php echo $fullname; ?>" <?php echo @$section['S2.1']['see']?'':'disabled';?>>
                                                    <label class="form-label">Reported by:<i>(MRB)</i></label>
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="qa_reinsp_verification_user_id" name="qa_reinsp_verification_user_id" class="form-control" <?php echo @$section['S2.2']['see']?'':'disabled';?>>
                                                    <label class="form-label">QA Re-inspection Verification:<i>(Leader & Above)</i></label>
                                                </div>
                                            </div>
                                            <input type="radio" id="qa_reinsp_accept" name="qa_reinsp_select" class="with-gap" value="1" <?php echo @$section['S2.1']['de']?'':'disabled';?>>
                                            <label for="qa_reinsp_accept">Accept</label>
                                            <input type="radio" id="qa_reinsp_reject" name="qa_reinsp_select" class="with-gap" value="0" <?php echo @$section['S2.1']['de']?'':'disabled';?>>
...
$(function() {
    ...
    $('#issueto_user').attr('disabled', true);
