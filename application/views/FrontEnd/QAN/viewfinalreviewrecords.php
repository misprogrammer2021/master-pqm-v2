    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-teal">
                <li class="active"><a href="<?=base_url('DashboardFinalReviewQAEngineer')?>"><i class="material-icons">home</i> Home</a></li>
                <li><i class="material-icons">library_books</i> Final Review By Quality Engineer</li>
            </ol>
        </div>
    </div>
</section>
                        ...
                        <div class="body">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="issued_by_user" name="issued_by_user" class="form-control" value='<?php echo $user[$data[0]->issueby_user_id];?>' disabled/>
                                                <label class="form-label">ISSUED BY</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="issueto_user" name="issueto_user" class="form-control" value='<?php echo $user[$data[0]->issueto_user];?>' disabled/>
                                                <label class="form-label">TO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="datetime" name="datetime" class="datetimepicker form-control" value='<?php echo $data[0]->datetime;?>' disabled/>
                                                <label class="form-label">DATETIME</label>
                                            </div>
                                        </div>
                                        <input type="checkbox" id="ooc" name="ooc" class="filled-in" value="1" <?php if ($data[0]->ooc == '1') echo 'checked';?> disabled>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="clearfix"></div>
                                            <input type="checkbox" id="oos" name="oos" class="filled-in" value="1" <?php if ($data[0]->oos == '1') echo 'checked';?> disabled>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="machine_no" name="machine_no" class="form-control" value='<?php echo $data[0]->machine_no;?>' disabled/>
                                                <label class="form-label">M/C NO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="up_affected" name="up_affected" class="form-control" value='<?php echo $data[0]->up_affected;?>' disabled/>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <textarea id="defect_description" name="defect_description" class="form-control" disabled><?php echo $data[0]->defect_description;?></textarea>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="last_passed_sample" name="last_passed_sample" class="datetimepicker form-control" value='<?php echo $data[0]->last_passed_sample;?>' disabled/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="purge_from" name="purge_from" class="datetimepicker form-control" value='<?php echo $data[0]->purge_from;?>' disabled/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_prod_user" name="ack_prod_user" class="form-control" value='<?php echo $user[$data[0]->ack_prod_user];?>' disabled/>
                                                </div>
                                            </div>
                                        </div><br/> 
                                        <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="estimate_qty" name="estimate_qty" class="form-control" value='<?php echo $data[0]->estimate_qty;?>' disabled/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_qa_user" name="ack_qa_user" class="form-control" value='<?php echo $user[$data[0]->ack_qa_user];?>' disabled/>
                                                </div>
                                            </div>
                                        </div><br/> 
                                        <div class="col-md-12 col-sm-12">
                                            <table class="table table-hover table-bordered qasample-form">
                                                ...
                                                <?php 
                                                    ...
                                                    echo "<tr>";    
                                                        ...
                                                        echo "<td>";
                                                            echo "<input type='number' value='$tempqty' name='input_qty_qasample[$qasampleloc->id]' class='form-control input_qty_qasample' disabled>";
                                                        echo "</td>";
                                                    echo "</tr>";
                                ...
                                <div class="clearfix"></div>
                                    <div class="col-md-12 col-sm-12">
                                            ...
                                            <table class="table table-hover table-bordered mrb-form">
                                                ...
                                                <?php 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <input type="checkbox" id="loc_purge'.$loctopurge->id.'" name="loc_purge['.$loctopurge->id.']" class="filled-in checkbox-active" '.($tempqty1 > 0 ? 'checked':'').' disabled>
                                                            ...
                                                            <td>
                                                                <input type="number" id="total-rejqty" name="rej_qty['.$loctopurge->id.']" value="'.$tempqty3.'" class="form-control reject-total" disabled>
                                                            </td>
                                                            <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <input type="text" id="total-affqty" name="qa_sample_affected_qty" class="form-control qasample-qty" value='<?php echo $totalSample;?>' disabled>
                                                        </td>
                                                        <td>
                                                            <input type="number" id="total-goodqty" name="qa_sample_good_qty" class="form-control qasample-qty" value="<?php echo $data[0]->qa_sample_good_qty;?>" disabled> 
                                                        </td>
                                                        <td>
                                                            <input type="number" id="total-rejqty" name="qa_sample_reject_qty" class="form-control qasample-qty" value="<?php echo $data[0]->qa_sample_reject_qty;?>" disabled>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="checkbox" id="scrap" name="scrap" class="filled-in" value="1" onclick="enableDisableAll();" <?php if ($data[0]->scrap == '1') echo 'checked';?> disabled/>
                                            <label for="scrap">SCRAP</label>
                                            <input type="checkbox" id="rework" name="rework" class="filled-in" value="1" onclick="enableDisableAll();" <?php if ($data[0]->rework == '1') echo 'checked';?> disabled/>
                                            <label for="rework">REWORK</label>
                                            <input type="checkbox" id="UAI" name="UAI" class="filled-in" value="1" onclick="enableDisableAll();" <?php if ($data[0]->uai == '1') echo 'checked';?> disabled/>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="reported_by_mrb" name="reported_by_mrb" class="form-control" value='<?php echo $user[$data[0]->reportby_user_id];?>' disabled/>
                                                    <label class="form-label">Reported by:<i>(MRB)</i></label>
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="qa_reinsp_verification_user_id" name="qa_reinsp_verification_user_id" class="form-control" value='<?php echo $user[$data[0]->qa_reinsp_verification_user_id];?>' disabled/>
                                                    <label class="form-label">QA Re-inspection Verification:<i>(Leader & Above)</i></label>
                                                </div>
                                            </div>
                                            <input type="radio" id="qa_reinsp_accept" name="qa_reinsp_select" class="with-gap" value="1" <?php if ($data[0]->qa_reinsp_status_accept == '1') echo 'checked';?> disabled>
                                            <label for="qa_reinsp_accept">Accept</label>
                                            <input type="radio" id="qa_reinsp_reject" name="qa_reinsp_select" class="with-gap" value="0" <?php if ($data[0]->qa_reinsp_status_reject == '0') echo 'checked';?> disabled>
...
<!-- Vertical Layout | With Floating Label -->
                        ...
                        <div class="body"> 
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea id="root_cause" name="root_cause[1][]" class="form-control" disabled><?php echo $rcsubmissiondata->root_cause;?></textarea>
                                            <label class="form-label">ROOT CAUSE</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea id="corrective_action" name="corrective_action[1][]" class="form-control" disabled><?php echo $rcsubmissiondata->corrective_action;?></textarea>
                                            <label class="form-label">CORRECTIVE ACTION</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_pic_user" name="rcfa_pic_user[1][]" class="form-control" value="<?php echo $user[$rcsubmissiondata->rcfa_pic_user_id];?>" disabled>
                                            <label class="form-label">PERSON IN-CHARGE</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_ack_by_eng" name="rcfa_ack_by_eng[1][]" class="form-control" value="<?php echo $user[$rcsubmissiondata->rcfa_ack_user_id];?>" disabled>
                                            <label class="form-label">ACKNOWLEDGED BY <i>Engineer / Manager (Eng Dept)</i></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_approved_by" name="rcfa_approved_by[1][]" class="form-control" value="<?php echo $user[$rcsubmissiondata->rcfa_appr_user_id];?>" disabled>
                                            <label class="form-label">APPROVED BY <i>Leader & Above</i></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <b>QA Inspection Data - Submission <?php echo $subno;?></b>
                                    <div class="form-group form-float"><br/>
                                        <div class="form-line">
                                            <input type="text" id="submit_by" name="submit_by[1][]" class="form-control" value="<?php echo $user[$rcsubmissiondata->completion_user_id];?>" disabled>
                                            <label class="form-label">Submit By:</label>                                                    
                                        </div>
                                    </div>
                                    <?php
                                        ...
                                        if($tablecol==0){
                                            ...
                                            echo $row[$tablerow][$tablecol];
                                                ...
                                                if($tablerow==0){
                                                    ...
                                                    echo '<input type="checkbox" id="'.$cb_id_val.'" disabled name="qa_insp_machine['.$subno.']['.$cb_id.']" class="filled-in checkbox-tab" '.$cb_checked.'/>';
                                                ...
                                                if($tablerow==1){
                                                    ...
                                                    echo '<div class="selectresult">';
                                                    //inspect_by1_2
                                                    echo '<select id="'.$insp_id_val.'" disabled class="form-control show-tick" name="inspect_by['.$subno.']['.$cb_id.']">';
                                                ...
                                                if($tablerow==2){
                                                    ...
                                                    echo '<input id="'.$time_start_val.'" disabled type="text" name="time_start['.$subno.']['.$cb_id.']" value="'.$row[$tablerow][$tablecol].'" class="timepicker form-control">';
                                                }

                                                if($tablerow==3){

                                                    $time_end_val = 'time_end_'.$subno.'_machine'.$cb_id;
                                                    echo '<input id="'.$time_end_val.'" disabled type="text" name="time_end['.$subno.']['.$cb_id.']" value="'.$row[$tablerow][$tablecol].'" class="timepicker form-control">';
                                                }
                                                ...
                                                if($tablerow==4){
                                                    ...
                                                    echo '<div class="selectresult">';
                                                    echo '<select id="'.$result_id_val.'" disabled class="form-control show-tick" name="rc_result['.$subno.']['.$cb_id.']">';
                                                    echo '    <option value="" disabled '.$select_default.'>-- Please Select --</option>';
                        ...
                        <div class="body">
                                <div class="row clearfix">
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <input type="radio" id="machine_status1" name="machine_status" class="with-gap" value="1" <?php if ($data[0]->machine_status == '1') echo 'checked';?> disabled/>  
                                            <label for="machine_status1">RUN</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="approval_user_id" name="approval_user_id" class="form-control" value='<?php echo $user[$data[0]->approval_user_id];?>' disabled/>
                                                    <label class="form-label">APPROVED BY</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="radio" id="machine_status2" name="machine_status" class="with-gap" value="0" <?php if ($data[0]->machine_status == '0') echo 'checked';?> disabled/> 
                                            <label for="machine_status2">STOP</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="machine_stop_reason" name="machine_stop_reason" class="form-control" value='<?php echo $data[0]->machine_stop_reason;?>' disabled/>  
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="<?php echo base_url().'FrontEnd/updatereviewbyqa/'.$data[0]->machine_id ;?>">   
                                <div class="row clearfix">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="purging_completed1" name="purging_completed" class="with-gap" value="1" <?php if ($data[0]->purge_status == '1') echo 'checked';?>/>  
                                        <label for="purging_completed1">YES</label>
                                        <input type="radio" id="purging_completed2" name="purging_completed" class="with-gap" value="0" <?php if ($data[0]->purge_status == '0') echo 'checked';?>/>  
                                        <label for="purging_completed2">No</label>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="closed_by" name="closed_by" class="form-control" value='<?php echo $user[$data[0]->closedby_user_id];?>'/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="notify_next1" name="notify_next" class="with-gap" value="1" <?php if ($data[0]->notify_next_process == '1') echo 'checked';?>/>  
                                        <label for="notify_next1">YES</label>
                                        <input type="radio" id="notify_next2" name="notify_next" class="with-gap" value="0" <?php if ($data[0]->notify_next_process == '0') echo 'checked';?>/>  
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="validation_result1" name="validation_result" class="with-gap" value="1" <?php if ($data[0]->fix_validation_result == '1') echo 'checked';?>/>  
                                        <label for="validation_result1">PASS</label>
                                        <input type="radio" id="validation_result2" name="validation_result" class="with-gap" value="0" <?php if ($data[0]->fix_validation_result == '0') echo 'checked';?>/>  
