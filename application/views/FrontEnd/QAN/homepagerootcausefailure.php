...
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="info-box bg-pink hover-expand-effect">
        <div class="icon">
            <a href="<?php echo base_url().'ViewListCompleteMaterialReviewBoard'; ?>"><i class="material-icons">playlist_add_check</i></a>
        </div>
        <div class="content">
            <p>LIST COMPLETE MATERIAL REVIEW BOARD RECORDS</p>
...
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="info-box bg-pink hover-expand-effect">
        <div class="icon">
            <a href="<?php echo base_url().'ViewRootCauseFailure'; ?>"><i class="material-icons">playlist_add_check</i></a>
        </div>
        <div class="content">
            <p>VIEW ROOT CAUSE FAILURE RECORDS</p>
            <!-- <div class="number count-to" data-from="0" data-to="125" data-speed="15" data-fresh-interval="20">125</div> -->
        </div>
    </div>
</div>
