...
<form method="post" action="<?php echo base_url().'FrontEnd/machinebreakdownform' ?>">
<?php echo validation_errors(); ?> 
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-teal">
            <li class="active"><a href="<?=base_url('DashboardMachineBreakdown')?>"><i class="material-icons">home</i> Home</a></li>                <li><i class="material-icons">library_books</i> Machine Break Down Form</li>
            </ol>
        </div>
    </div>
</section>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="issued_by_user" name="issued_by_user" class="form-control" value="<?php echo $fullname; ?>" disabled>
                                                <label class="form-label">ISSUED BY</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="issueto_user" name="issueto_user" class="form-control" disabled />
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="datetime" name="datetime" class="<?php echo @$section['S1']['de']?'datetimepicker':'';?>  form-control" <?php echo @$section['S1']['de']?'':'disabled';?> required>
                                                <label class="form-label">DATETIME</label>
                                            </div>
                                        </div>
                                        <input type="checkbox" id="ooc" name="ooc" class="filled-in" value="1" <?php echo @$section['S1']['de']?'':'disabled';?>>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="to_dept" name="to_dept" class="form-control show-tick" disabled>
                                                    <option value="">--Please Select--</option>
                                        ...
                                        <div class="clearfix"></div>
                                            <input type="checkbox" id="oos" name="oos" class="filled-in" value="1" <?php echo @$section['S1']['de']?'':'disabled';?>>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="form-group form-float"><br/>
                                            <div class="form-line">
                                                <input type="text" id="cav_no" name="cav_no" class="form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="machine_no" name="machine_no" class="form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                                <label class="form-label">M/C NO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="up_affected" name="up_affected" class="form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <textarea id="defect_description" name="defect_description" class="form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required></textarea>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="last_passed_sample" name="last_passed_sample" class="<?php echo @$section['S1.1']['de']?'datetimepicker':'';?>  form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_eng_user" name="ack_eng_user" class="form-control" <?php echo @$section['S1.4']['ack']?'':'disabled';?> >
                                                </div>
                                            </div>
                                        </div><br/>
                                    </div> 
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="purge_from" name="purge_from" class="<?php echo @$section['S1.1']['de']?'datetimepicker':'';?>  form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_prod_user" name="ack_prod_user" class="form-control" <?php echo @$section['S1.5']['ack']?'':'disabled';?> >
                                                </div>
                                            </div>
                                        </div><br/>
                                        <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="estimate_qty" name="estimate_qty" class="form-control" <?php echo @$section['S1.1']['de']?'':'disabled';?> required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_qa_user" name="ack_qa_user" class="form-control" <?php echo @$section['S1.6']['ack']?'':'disabled';?> >
                                                </div>
                                            </div>
                                        </div><br/>
                                        <div class="col-md-12 col-sm-12">
                                            <table class="table table-hover table-bordered qasample-form">
                                                ...
                                                <?php 
                                                    ...
                                                    echo "<tr>";    
                                                        ...
                                                        echo "<td>";
                                                            echo "<input type='number' id='input_qty_qasample' value='' name='input_qty_qasample[$qasampleloc->id]' class='form-control'".(@$section['S1.2']['de']?'':'disabled').">";
                                                        echo "</td>";
                                                    echo "</tr>";
                                    ...
                                    <button id="form" type="submit" name="submit" value="SUBMIT" class="btn btn-success m-t-15 waves-effect pull-right" <?php echo @$section['S1']['de']?'':'disabled';?>>SUBMIT</button>
