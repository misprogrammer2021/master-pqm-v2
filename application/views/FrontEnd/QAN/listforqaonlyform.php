        ...
        <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                List To Review By Quality Engineer
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php
                                        $i=1;
                                            foreach($listforqaonlyform as $row)
                                            {
                                        echo "<tr>";
                                            
                                            echo "<td><a href='".base_url()."viewlistforqaonlyform/".$row->id."'><i class='material-icons'>pageview</i></a></td>";
                                            echo "<td>".$i."</td>";
