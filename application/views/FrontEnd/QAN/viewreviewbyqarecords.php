                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <button class="btn bg-green btn-lg btn-block waves-effect pull-right" type="button">
                                       ...
                                       <input type="text" id="qan_no" name="qan_no" class="form-control" value="<?php echo $listforqaonlyform[0]->qan_no;?>"/>
                                    </button>
                                </li>
                                <li>
                                    <button class="btn bg-green btn-lg btn-block waves-effect pull-right" type="button">
                                        ...
                                        <input type='text' id='status' name='status' class='form-control' value='<?php echo $listforqaonlyform[0]->status;?>'/>
                                    </button>
                                </li>
                                <li class="dropdown">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="issued_by_user" name="issued_by_user" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->issueby_user_id];?>'/>
                                                <label class="form-label">ISSUED BY</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="issueto_user" name="issueto_user" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->issueto_user];?>'/>
                                                <label class="form-label">TO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="datetime" name="datetime" class="datetimepicker form-control" value='<?php echo $listforqaonlyform[0]->datetime;?>'/>
                                                <label class="form-label">DATETIME</label>
                                            </div>
                                        </div>
                                        <input type="checkbox" id="ooc" name="ooc" class="filled-in" value="1" <?php if ($listforqaonlyform[0]->ooc == '1') echo 'checked';?>>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="issued_dept" name="issued_dept" class="form-control" value='<?php echo $listforqaonlyform[0]->issued_dept;?>'/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="to_dept" name="to_dept" class="form-control" value='<?php echo $listforqaonlyform[0]->to_dept;?>'/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="shift" name="shift" class="form-control" value='<?php echo $listforqaonlyform[0]->shift;?>'/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                            <input type="checkbox" id="oos" name="oos" class="filled-in" value="1" <?php if ($listforqaonlyform[0]->oos == '1') echo 'checked';?>>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="part_name" name="part_name" class="form-control" value='<?php echo $partname[$listforqaonlyform[0]->part_name];?>'/>
                                                </div>
                                            </div>
                                        </div><br/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="machine_no" name="machine_no" class="form-control" value='<?php echo $listforqaonlyform[0]->machine_no;?>'/>
                                                <label class="form-label">M/C NO</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="up_affected" name="up_affected" class="form-control" value='<?php echo $listforqaonlyform[0]->up_affected;?>'/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="process" name="process" class="form-control" value='<?php echo $procees[$listforqaonlyform[0]->process];?>'/>
                                                </div>
                                            </div>
                                        </div><br/>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="detectedby_user" name="detectedby_user" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->detectedby_user];?>'/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <textarea id="defect_description" name="defect_description" class="form-control"><?php echo $listforqaonlyform[0]->defect_description;?></textarea>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="last_passed_sample" name="last_passed_sample" class="datetimepicker form-control" value='<?php echo $listforqaonlyform[0]->last_passed_sample;?>'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_eng_user" name="ack_eng_user" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->ack_eng_user];?>'/>
                                                </div>
                                            </div>
                                        </div><br/>
                                    </div> 
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="purge_from" name="purge_from" class="datetimepicker form-control" value='<?php echo $listforqaonlyform[0]->purge_from;?>'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_prod_user" name="ack_prod_user" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->ack_prod_user];?>'/>
                                                </div>
                                            </div>
                                        </div><br/> 
                                        <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="estimate_qty" name="estimate_qty" class="form-control" value='<?php echo $listforqaonlyform[0]->estimate_qty;?>'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-line">
                                                    <input type="text" id="ack_qa_user" name="ack_qa_user" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->ack_qa_user];?>'/>
                                                </div>
                                            </div>
                                        </div><br/> 
                                        <div class="col-md-12 col-sm-12">
                                            <table class="table table-hover table-bordered qasample-form">
                                                ...
                                                <?php 
                                                        ...
                                                        {
                                                            foreach($listforqaonlyform as $qty => $data2){
                                ...
                                <div class="clearfix"></div>
                                    <div class="col-md-12 col-sm-12">
                                        <div class="col-md-8 col-sm-8">
                                            <table class="table table-hover table-bordered mrb-form">
                                                ...
                                                <?php 
                                                        ...
                                                        {
                                                            foreach($listforqaonlyform as $qty => $data3){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" id="total-goodqty" name="qa_sample_good_qty" class="form-control qasample-qty" value="<?php echo $listforqaonlyform[0]->qa_sample_good_qty;?>">
                                                        </td>
                                                        <td>
                                                            <input type="number" id="total-rejqty" name="qa_sample_reject_qty" class="form-control qasample-qty" value="<?php echo $listforqaonlyform[0]->qa_sample_reject_qty;?>">
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <input type="checkbox" id="scrap" name="scrap" class="filled-in" value="1" onclick="enableDisableAll();" <?php if ($listforqaonlyform[0]->scrap == '1') echo 'checked';?>/>
                                            <label for="scrap">SCRAP</label>
                                            <input type="checkbox" id="rework" name="rework" class="filled-in" value="1" onclick="enableDisableAll();" <?php if ($listforqaonlyform[0]->rework == '1') echo 'checked';?>/>
                                            <label for="rework">REWORK</label>
                                            <input type="checkbox" id="UAI" name="UAI" class="filled-in" value="1" onclick="enableDisableAll();" <?php if ($listforqaonlyform[0]->uai == '1') echo 'checked';?>/>
                                            <label for="UAI">UAI</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="rework_order" name="rework_order" class="form-control" value='<?php echo $listforqaonlyform[0]->rework_order_no;?>' disabled /> 
                                                    <label class="form-label">Rework order #<i>(if any)</i></label>
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="scrap_no" name="scrap_no" class="form-control" value='<?php echo $listforqaonlyform[0]->scrap_no;?>' disabled /> 
                                                    <label class="form-label">Scrap #<i>(if any)</i></label>
                                                </div>
                                            </div>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="UAI_no" name="UAI_no" class="form-control" required="required" value='<?php echo $listforqaonlyform[0]->uai_no;?>' disabled />
                                            ...
                                            <table class="table table-hover table-bordered">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" id="input_rework_uai" name="input_rework_uai" class="form-control" value='<?php echo $listforqaonlyform[0]->rework_dispo_input;?>' disabled />
                                                    </td>
                                                    <td>
                                                        <input type="text" id="output_rework_uai" name="output_rework_uai" class="form-control" value='<?php echo $listforqaonlyform[0]->rework_dispo_output;?>' disabled/>
                                                    </td>
                                                    <td>
                                                        <input type="text" id="rej_scrap" name="rej_scrap" class="form-control rework-open" value='<?php echo $listforqaonlyform[0]->rework_dispo_rej_scrap;?>' disabled/>
                                                    </td>
                                                </tr>
                                            </table>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="reported_by_mrb" name="reported_by_mrb" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->reportby_user_id];?>'/>
...
<!-- Vertical Layout | With Floating Label -->
                        ...
                        <div class="body"> 
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="rcfa_approved_by" name="rcfa_approved_by[1][]" class="form-control" value="<?php echo $user[$rcsubmissiondata->rcfa_appr_user_id];?>">
                                            <label class="form-label">APPROVED BY <i>Leader & Above</i></label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="body">
                                <div class="row clearfix">
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <input type="radio" id="machine_status1" name="machine_status" class="with-gap" value="1" <?php if ($listforqaonlyform[0]->machine_status == '1') echo 'checked';?>/>  
                                            <label for="machine_status1">RUN</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="approval_user_id" name="approval_user_id" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->approval_user_id];?>'/>
                                                    <label class="form-label">APPROVED BY</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="radio" id="machine_status2" name="machine_status" class="with-gap" value="0" <?php if ($listforqaonlyform[0]->machine_status == '0') echo 'checked';?>/> 
                                            <label for="machine_status2">STOP</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="machine_stop_reason" name="machine_stop_reason" class="form-control" value='<?php echo $listforqaonlyform[0]->machine_stop_reason;?>' />  
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="<?php echo base_url().'FrontEnd/updatereviewbyqa/'.$listforqaonlyform[0]->machine_id ;?>">   
                                <div class="row clearfix">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="purging_completed1" name="purging_completed" class="with-gap" value="1" <?php if ($listforqaonlyform[0]->purge_status == '1') echo 'checked';?>/>  
                                        <label for="purging_completed1">YES</label>
                                        <input type="radio" id="purging_completed2" name="purging_completed" class="with-gap" value="0" <?php if ($listforqaonlyform[0]->purge_status == '0') echo 'checked';?>/>  
                                        <label for="purging_completed2">No</label>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="closed_by" name="closed_by" class="form-control" value='<?php echo $user[$listforqaonlyform[0]->closedby_user_id];?>'/>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="notify_next1" name="notify_next" class="with-gap" value="1" <?php if ($listforqaonlyform[0]->notify_next_process == '1') echo 'checked';?>/>  
                                        <label for="notify_next1">YES</label>
                                        <input type="radio" id="purging_completed2" name="notify_next" class="with-gap" value="0" <?php if ($listforqaonlyform[0]->notify_next_process == '0') echo 'checked';?>/>  
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <input type="radio" id="validation_result1" name="validation_result" class="with-gap" value="1" <?php if ($listforqaonlyform[0]->fix_validation_result == '1') echo 'checked';?>/>  
                                        <label for="validation_result1">PASS</label>
                                        <input type="radio" id="validation_result2" name="validation_result" class="with-gap" value="0" <?php if ($listforqaonlyform[0]->fix_validation_result == '0') echo 'checked';?>/>  
