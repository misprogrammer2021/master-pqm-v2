                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="col-md-8 col-sm-8">
                                ...
                                <div id="sublot_checkbox">
                                    ...
                                    <input type="checkbox" id="vmi" name="vmi" class="filled-in" value="1" <?php if (@$data->vmi == '1') echo 'checked' ;?> <?php echo @$section['S2.5']['de']?'':'disabled';?>>
                            ...
                            <div class="col-md-8 col-sm-8">
                                        ...
                                        <?php 
                                            ...
                                            if(@$data->buy_off){
                                                ...
                                                foreach(@$data->buy_off as $buyoff){
                                                    ...
                                                    echo '<tr id="rec-1">';
                                                        echo '<td>
                                                            <input type="number" id="qty_buyoff" name="qty_buyoff[]" class="form-control" value="'.$buyoff->qty_buyoff.'">
                                                        </td>
                                                        <td>
                                                            <input type="number" id="bosorting_good_qty" name="bosorting_good_qty[]" class="form-control" value="'.$buyoff->sorting_good_qty.'">
                                                        </td>
                                                        <td>
                                                            <input type="number" id="sorting_ooc_qty" name="sorting_ooc_qty[]" class="form-control" value="'.$buyoff->sorting_ooc_qty.'">
                                                        </td>
                                                        <td>
                                                            <input type="number" id="sorting_oos_qty" name="sorting_oos_qty[]" class="form-control" value="'.$buyoff->sorting_oos_qty.'">
                                                        </td>
                                                        <td>
                                ...
                                <div style="display:none;">
                                    <table id="clone_tbl_buyoff">
                                        <tr id="">
                                            <td>
                                                <input type="number" id="qty_buyoff" name="qty_buyoff[]" class="form-control" value=''>
                                            </td>
                                            <td>
                                                <input type="number" id="bosorting_good_qty" name="bosorting_good_qty[]" class="form-control" value=''>
                                            </td>
                                            <td>
                                                <input type="number" id="sorting_ooc_qty" name="sorting_ooc_qty[]" class="form-control" value=''>
                                            </td>
                                            <td>
                                                <input type="number" id="sorting_oos_qty" name="sorting_oos_qty[]" class="form-control" value=''>
                                            </td>
                                            <td>
