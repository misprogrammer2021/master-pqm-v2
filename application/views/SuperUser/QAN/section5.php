                ...
                <div class="row clearfix">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <input type="radio" id="purging_completed1" name="purging_completed" class="with-gap" value="1" <?php if (@$data->purge_status == '1') echo 'checked';?> <?php echo @$section['QASU5']['de']?'':'disabled';?>>   
                            <label for="purging_completed1">YES</label>
                            <input type="radio" id="purging_completed2" name="purging_completed" class="with-gap" value="0" <?php if (@$data->purge_status == '0') echo 'checked';?> <?php echo @$section['QASU5']['de']?'':'disabled';?>>    
                            <label for="purging_completed2">No</label>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="closed_by" name="closed_by" class="form-control" value='<?php echo @$data->user->{$data->closedby_user_id};?>' <?php echo @$section['QASU5']['see']?'':'disabled';?>>  
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <input type="radio" id="notify_next1" name="notify_next_process" class="with-gap" value="1" <?php if (@$data->notify_next_process == '1') echo 'checked';?> <?php echo @$section['QASU5']['de']?'':'disabled';?>>      
                            <label for="notify_next1">YES</label>
                            <input type="radio" id="notify_next2" name="notify_next_process" class="with-gap" value="0" <?php if (@$data->notify_next_process == '0') echo 'checked';?> <?php echo @$section['QASU5']['de']?'':'disabled';?>>      
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <input type="radio" id="validation_result1" name="validation_result" class="with-gap" value="1" <?php if (@$data->fix_validation_result == '1') echo 'checked';?> <?php echo @$section['QASU5']['de']?'':'disabled';?>>      
                            <label for="validation_result1">PASS</label>
                            <input type="radio" id="validation_result2" name="validation_result" class="with-gap" value="0" <?php if (@$data->fix_validation_result == '0') echo 'checked';?> <?php echo @$section['QASU5']['de']?'':'disabled';?>>      
