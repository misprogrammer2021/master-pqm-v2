...
include('D:\xampp\htdocs\PQM\application\views\SuperUser\QAN\section1.php');
if(@$show_section3 == TRUE OR @$show_allsection == TRUE)
include('D:\xampp\htdocs\PQM\application\views\SuperUser\QAN\section3.php');
if(@$show_section4 == TRUE OR @$show_allsection == TRUE)
include('D:\xampp\htdocs\PQM\application\views\SuperUser\QAN\section4.php');
if(@$show_section2 == TRUE OR @$show_allsection == TRUE)
include('D:\xampp\htdocs\PQM\application\views\SuperUser\QAN\section2.php');
if(@$show_section5 == TRUE OR @$show_allsection == TRUE)
include('D:\xampp\htdocs\PQM\application\views\SuperUser\QAN\section5.php');
...
function defect_desc_dropdown(){
    ...
    if(types == ''){
        ...
        $.post("<?=base_url('SuperUser/get_defect_desc');?>",{ defect_type: types })
        .done(function(data) {
            showOrHide = true;
