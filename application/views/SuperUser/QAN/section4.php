                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="radio" id="machine_status1" name="machine_status" class="with-gap" value="1" <?php if (@$data->machine_status == '1') echo 'checked';?> <?php echo @$section['QASU4']['de']?'':'disabled';?>> 
                                <label for="machine_status1">RUN</label>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="approval_user" name="approval_user" class="form-control" value='<?php echo @$data->user->{$data->approval_user_id};?>' <?php echo @$section['QASU4']['see']?'':'disabled';?>>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input type="radio" id="machine_status2" name="machine_status" class="with-gap" value="0" <?php if (@$data->machine_status == '0') echo 'checked';?> <?php echo @$section['QASU4']['de']?'':'disabled';?>> 
                                <label for="machine_status2">STOP</label>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="machine_stop_reason" name="machine_stop_reason" class="form-control" value='<?php echo @$data->machine_stop_reason;?>' <?php echo @$section['QASU4']['de']?'':'disabled';?>> 
