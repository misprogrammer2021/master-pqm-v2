                        ...
                        <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="issued_dept" name="issued_dept" class="<?php //echo @$section['QASU1.1']['de']?'show-tick':'';?>  form-control" <?php //echo @$section['QASU1.1']['de']?'':'disabled';?> required>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select id="to_dept" name="to_dept" class="<?php //echo @$section['QASU1.1']['de']?'show-tick':'';?>  form-control" <?php //echo (@$section['QASU1.1']['de'] and ($data->issueby_user_id<1 OR $data->issueby_user_id==$this->session->userdata['logged_in']['id']))?'':'disabled';?>>
                                                    <option value="">--Please Select--</option>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        ...
                                        <!-- <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="machine_no" name="machine_no" class="form-control" value='<?php echo @$data->machine_no;?>' <?php echo @$section['QASU1.2']['de']?'':'disabled';?> required/>
                                                <label class="form-label">M/C NO</label>
                                            </div>
                                        </div> -->
