                    ...
                    <div class="body">
                        ...
                        <div class="tab-content" id="eng_content2">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="others_corrective_action" name="others_corrective_action" class="form-control" <?php echo @$section['ENGSU3.1']['de']?'':'disabled';?>>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                    <input type="text" id="completion_user_id" name="completion_user_id[]" class="form-control" value="<?php echo @$section['ENGSU3.1']['see']?@$data->user->{$this->session->userdata['logged_in']['id']}:''; ?>" disabled>
                                    <input type="hidden" name="completion_user_id[]" value="<?php echo @$section['ENGSU3.1']['see']?$this->session->userdata['logged_in']['id']:'';?>" />    
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="completion_datetime" name="completion_datetime[]" class="form-control" <?php echo @$section['ENGSU3.1']['see']?'':'disabled';?>>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="remarks" name="remarks" class="form-control" <?php echo @$section['QASU3.2']['de']?'':'disabled';?>>
                        ...
                        ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="others_corrective_action" name="others_corrective_action[<?php echo $subno;?>]" value="<?php echo @$rcsubmissiondata->others_corrective_action;?>" class="form-control" <?php echo @$section['ENGSU3.1']['de']?'':'disabled';?>>
                                            <label class="form-label">OTHERS</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="remarks" name="remarks[<?php echo $subno;?>]" class="form-control" value="<?php echo @$rcsubmissiondata->remarks; ?>" <?php echo @$section['QASU3.2']['de']?'':'disabled';?>>
                                            <label class="form-label">Remarks</label>
                                        </div>
                                    </div>
                                </div> 
                                <div class="row clearfix">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="radio" id="machine_status1[<?php echo $subno;?>]" name="machine_status[<?php echo $subno;?>]" class="with-gap" value="1" <?php if (@$rcsubmissiondata->machine_status == '1') echo 'checked';?> <?php echo @$section['QASU3.5']['de']?'':'disabled';?>> 
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="radio" id="machine_status2[<?php echo $subno;?>]" name="machine_status[<?php echo $subno;?>]" class="with-gap" value="0" <?php if (@$rcsubmissiondata->machine_status == '0') echo 'checked';?> <?php echo @$section['QASU3.5']['de']?'':'disabled';?>> 
                                            <label for="machine_status2[<?php echo $subno;?>]">STOP</label>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" id="machine_stop_reason" name="machine_stop_reason[<?php echo $subno;?>]" class="form-control" value='<?php echo @$rcsubmissiondata->machine_stop_reason;?>' <?php echo @$section['QASU3.5']['de']?'':'disabled';?>> 
                                                    <label class="form-label">IF STOP, REASON:</label>
                                                </div>
                                            </div>
                                        </div>
